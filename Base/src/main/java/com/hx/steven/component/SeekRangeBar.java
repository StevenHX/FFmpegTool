...
public class SeekRangeBar extends View {
    ...
    public SeekRangeBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        notScrollBarBg = ContextCompat.getDrawable(_context, R.drawable.hp_wbf);

        hasScrollBarBg = ContextCompat.getDrawable(_context, R.drawable.hp_ybf);

        mThumbLow = ContextCompat.getDrawable(_context,R.drawable.hp_a);

        mThumbHigh = ContextCompat.getDrawable(_context,R.drawable.hp_b);
