...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
  ...
  private int mMaxWidth = TrimVideoUtil.VIDEO_FRAMES_WIDTH;
  ...
  private void init(Context context) {
    ...
    setUpListeners();
    mFinalPath = CreateConstants.PHOTO_ALBUM_PATH +System.currentTimeMillis()+".mp4";
  }
  ...
  private void onSaveClicked() {
    if (mRightProgressPos - mLeftProgressPos < TrimVideoUtil.MIN_SHOOT_DURATION) {
      ...
      mVideoView.pause();
      TrimVideoUtil.trim(mContext, mSourceUri.getPath(), mFinalPath, mLeftProgressPos, mRightProgressPos, mOnTrimVideoListener);
    }
  }
